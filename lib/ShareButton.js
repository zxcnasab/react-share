...
function windowOpen(url, _a, onClose) {
    ...
    var config = __assign({ height: height,
        width: width, location: 'no', toolbar: 'no', status: 'no', directories: 'no', menubar: 'no', scrollbars: 'yes', resizable: 'no', centerscreen: 'yes', chrome: 'yes', target: '_blank' }, configRest);
    if (configRest && configRest.opts && configRest.opts.target && configRest.opts.target === "_blank") {
        var shareDialog = window.open(url, 'sharer' + 'target=_blank');
        return shareDialog;
    }
    else {
        var shareDialog_1 = window.open(url, '', Object.keys(config)
            .map(function (key) { return key + "=" + config[key]; })
            .join(', '));
        if (onClose) {
            var interval_1 = window.setInterval(function () {
                try {
                    if (shareDialog_1 === null || shareDialog_1.closed) {
                        window.clearInterval(interval_1);
                        onClose(shareDialog_1);
                    }
                }
                catch (e) {
...
var ShareButton = /** @class */ (function (_super) {
    ...
    function ShareButton() {
        ...
        _this.openShareDialog = function (link, opts) {
            var _a = _this.props, onShareWindowClose = _a.onShareWindowClose, _b = _a.windowHeight, windowHeight = _b === void 0 ? 400 : _b, _c = _a.windowPosition, windowPosition = _c === void 0 ? 'windowCenter' : _c, _d = _a.windowWidth, windowWidth = _d === void 0 ? 550 : _d;
            var windowConfig = __assign({ height: windowHeight, width: windowWidth, opts: opts }, (windowPosition === 'windowCenter'
